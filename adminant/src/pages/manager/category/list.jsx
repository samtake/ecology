...
//   import UpdateForm from './components/UpdateForm';
  ...
  class TableList extends Component {
    ...
    componentDidMount() {
      ...
      dispatch({
        type: 'managerCategoryModel/list',
      });
    }
    ...
    handleCreate = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCategoryModel/create',
        payload: {
          ...fields,
        },
      });
    ...
    handleUpdate = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCategoryModel/update',
        payload: {
          ...fields,
        },
      });
    ...
    handleEnableModalVisible = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCategoryModel/enable',
        payload: {
          ...fields,
        },
      });
    ...
    handleDeleteModalVisible = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCategoryModel/delete',
        payload: {
          ...fields,
        },
      });
