...
//   import UpdateForm from './components/UpdateForm';
  ...
  class TableList extends Component {
    ...
    componentDidMount() {
      ...
      dispatch({
        type: 'managerCommentsModel/list',
      });
    }
    ...
    handleCreate = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCommentsModel/create',
        payload: {
          ...fields,
        },
      });
    ...
    handleUpdate = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCommentsModel/update',
        payload: {
          ...fields,
        },
      });
    ...
    handleEnableModalVisible = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCommentsModel/enable',
        payload: {
          ...fields,
        },
      });
    ...
    handleDeleteModalVisible = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerCommentsModel/delete',
        payload: {
          ...fields,
        },
      });
