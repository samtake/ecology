...
//   import UpdateForm from './components/UpdateForm';
  ...
  class TableList extends Component {
    ...
    handleCreate = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerSettingModel/create',
        payload: {
          ...fields,
        },
      });
    ...
    handleUpdate = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerSettingModel/update',
        payload: {
          ...fields,
        },
      });
    ...
    handleEnableModalVisible = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerSettingModel/enable',
        payload: {
          ...fields,
        },
      });
    ...
    handleDeleteModalVisible = fields => {
      const { dispatch } = this.props;
      dispatch({
        type: 'managerSettingModel/delete',
        payload: {
          ...fields,
        },
      });
